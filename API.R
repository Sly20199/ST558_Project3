...
# Load data and fit best model (Randome Forest) on entire dataset
...
function() {
  list(
    ...
    github_pages = "https://github.com/Sly20199/ST558_Project3"
  )
}
...
function(){
  ...
  cm <- conf_mat(preds, truth = potability, estimate = .pred_clss)
